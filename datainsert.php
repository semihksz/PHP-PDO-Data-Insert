...
<!-- We are creating a simple bootstrap form. -->
<!doctype html>
<html lang="en">
...
<head>
    ...
    <title>PHP PDO Data Insert</title>
</head>

<body>
    <div class="container">
        <div class="card mt-5 p-5">
            <!-- We are writing a post on the method of the form. -->
            <form method="POST">
                ...
                <button type="submit" name="datainsert" class="btn btn-primary">Insert</button>
            </form>
        </div>
    </div>
